...
# class for working with TFT ILI4341 display
class Display:
    ...
    # constructing Display object with corresponding Bank object
    ...
    # refresh message, bank balance and input string on display    
    def refresh(self):
        self.display.erase()
    ...
    # refresh user input code on display     
